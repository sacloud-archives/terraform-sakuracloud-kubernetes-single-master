...
iptables -t filter -A INPUT -m tcp -p tcp --dport 6443 -j ACCEPT
iptables -t filter -A INPUT -m tcp -p tcp --dport 10250 -j ACCEPT
iptables -t filter -A INPUT -m tcp -p tcp --dport 10251 -j ACCEPT
iptables -t filter -A INPUT -m tcp -p tcp --dport 10252 -j ACCEPT
...
iptables -t filter -A FORWARD -o eth1 -m conntrack --ctstate RELATED,ESTABLISHED -j ACCEPT
